...
// [TAREFA 1A] Mongoose usa Queries Parametrizadas para prevenir SQLi
...
const login = async (req, res) => {
  ...
  try {
    ...
    // O email é tratado como valor, não como parte do comando
    ...
    // Validação de senha com bcrypt (Aula 18)
...
const registerUser = async (req, res) => {
    ...
    try {
        ...
        if (senha.length < 6) {
            return res.redirect('/register?erro=senha_fraca');
        }

        // Hash da senha com bcrypt (Aula 18)
